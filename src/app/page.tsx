...
export default async function HomePage() {
  ...
  return (
    <div className="bg-bg-primary">
      {/* Hero Section */}
      <section id="home" className="relative overflow-hidden bg-accent min-h-[100svh] md:min-h-0 md:py-20 flex flex-col">
        {/* Decorative elements */}
        ...
        <div className="hidden md:flex container-custom flex-col relative z-10">
          <div className="py-0">
            {/* Tagline */}
